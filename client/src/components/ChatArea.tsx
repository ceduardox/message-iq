...
const FAILED_MEDIA_STORAGE_KEY = "iqexcelencia_failed_media_ids_v1";
            ...
            <div key={msg.id} className="contents">
              ...
              >
                ...
                {isOut && existingCita ? (
                  ...
                  <Link
                    href="/reminders"
                    className="mt-2 inline-flex items-center gap-1.5 rounded-lg border border-green-500/40 bg-green-500/10 px-2.5 py-1 text-[11px] font-medium text-green-700 transition-colors hover:bg-green-500/20 dark:text-green-300"
                    title="Ver la llamada en la agenda"
